...
class StoreDataTestCase(unittest.TestCase):
  ...
  def test_store_data_without_graph_guesses_rdfxml_content_type(self):
    client = MockHttp()
    store = pynappl.Store('http://example.com/store', client=client)
    resp = store.store_data(SINGLE_TRIPLE)
  ...
  def test_store_data_without_graph_guesses_turtle_content_type(self):
    client = MockHttp()
    store = pynappl.Store('http://example.com/store', client=client)
    resp = store.store_data(SINGLE_TRIPLE_TURTLE)
  ...
  def test_store_data_without_graph_guesses_turtle_content_type(self):
    client = MockHttp()
    store = pynappl.Store('http://example.com/store', client=client)
    resp = store.store_data(SINGLE_TRIPLE_NTRIPLES)
  ...
  def test_store_data_with_graph_guesses_rdfxml_content_type(self):
    client = MockHttp()
    store = pynappl.Store('http://example.com/store', client=client)
    resp = store.store_data(SINGLE_TRIPLE, 'foo')
  ...
  def test_store_data_with_graph_guesses_turtle_content_type(self):
    client = MockHttp()
    store = pynappl.Store('http://example.com/store', client=client)
    resp = store.store_data(SINGLE_TRIPLE_TURTLE, 'foo')
  ...
  def test_store_data_with_graph_guesses_turtle_content_type(self):
    client = MockHttp()
    store = pynappl.Store('http://example.com/store', client=client)
    resp = store.store_data(SINGLE_TRIPLE_NTRIPLES, 'foo')
